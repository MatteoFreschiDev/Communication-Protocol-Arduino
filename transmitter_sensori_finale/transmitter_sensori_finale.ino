...
int infrared_sensor = 4; // This is our input pin
int infrared_message = HIGH;// HIGH MEANS NO OBSTACLE
int obstacle; 
...
char* create_message() {
  ...
  sprintf(message, "%d, %d", distance, infrared_message);
...
void loop() {
  obstacle = digitalRead(infrared_sensor);
